		...
		when 20412.chat."Bagjanamu Odasý " begin
			...
			if agree == 1 then
				...
				if party.is_party() then
					...
					say_center("grup üyesi olmaman gerekmektedir. ")
					return
				end
				...
				-- if d.find(party.getf("frt_dungeon_index")) and party_check then
					...
					-- say("")
					-- say("")
					-- say_center("Ýçeriye alýyorum seni. ")
					-- say("")
					-- wait()
				...
				if pc.count_item(30613) < 1 then
					...
					say("")
					say_center("Bu odaya eriþebilmek için ")
					say_center(string.format("Olmasý Gereken Eþya - %s. ", item_name(setting.ticket_vnum)))
					say_center("")
					return
				end
				...
				say_center("içeriye alacaðým seni. ")
				wait()
